...
# SECRET_KEY = 'django-insecure-6rung3=8aaf1xp=o$xq6d41c%fa2#8)qu^%)&d@h#0gi$gw)yf'
SECRET_KEY = ('DJANGO_SECRET_KEY', 'django-insecure-6rung3=8aaf1xp=o$xq6d41c%fa2#8)qu^%)&d@h#0gi$gw)yf')
...
SIMPLE_JWT = {
    ...
    "TOKEN_OBTA IN_SERIALIZER": "rest_framework_simplejwt.serializers.TokenObtainPairSerializer",
...
DADATA_SECRET_KEY = getenv('DADATA_SECRET_KEY')
